...
pub fn create_pomdp(gamma: f64) -> super::pomdp::POMDP {
    ...
    transition_function.insert(("hungry".to_string(), "feed".to_string()), vec![("sated".to_string(), 1.0)].into_iter().collect()); // T(sated | hungry, feed) = 100%
    ...
    reward_function.insert(("sated".to_string(), "sing".to_string()), 5.0);
    reward_function.insert(("hungry".to_string(), "sing".to_string()), -2.0);

    let mut observation_function: HashMap<(String, String, String), f64> = std::collections::HashMap::new(); 
    observation_function.insert(("crying".to_string(), "feed".to_string(), "hungry".to_string()), 0.0);
    observation_function.insert(("quiet".to_string(), "feed".to_string(), "hungry".to_string()), 1.0);
    observation_function.insert(("crying".to_string(), "feed".to_string(), "sated".to_string()), 0.0);
    observation_function.insert(("quiet".to_string(), "feed".to_string(), "sated".to_string()), 1.0);
    ...
    observation_function.insert(("crying".to_string(), "sing".to_string(), "hungry".to_string()), 1.0);
    observation_function.insert(("quiet".to_string(), "sing".to_string(), "hungry".to_string()), 0.0);
